/**
 * DESCRIPTION:
Karan's company makes software that provides different
 features based on the version of operating system of the user.
...
console.log(compareVersions('10.4.9.0.0.4', '10.4.9.0.5'));
